...
def main():
    argParser = argparse.ArgumentParser(description="GeCCo - Gene Content Counter, \
For more information see: https://github.com/TimVerschuren/GeCCo", formatter_class=RawTextHelpFormatter)
